  ...
  <li key={i}>
    <a href="#" className="block hover:bg-gray-50 transition duration-150 ease-in-out">
      <div className="flex items-center px-4 py-4 sm:px-6">
        ...
        {remove ? (
          <div>
            <svg onClick={remove} className="h-5 w-5 text-gray-400 hover:text-red-400" fill="currentColor" viewBox="0 0 20 20" onClick={remove}>
              <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"/>
            </svg>
          </div>) : ''
        }
            ...
            <div className="">
              <div>
                ...
                { url.length > 0 ? 
                  ...
                  (<div className="mt-2 flex items-center text-lg leading-5 text-gray-800">
                    <a href={url} target='_blank'> {publication} </a> 
                  </div>)
                }
              </div>
            </div>
