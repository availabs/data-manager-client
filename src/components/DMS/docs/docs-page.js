...
export default ({ title, chapter, body, footer, updated_at, ...props }) =>
  <div className="max-w-lg grid grid-cols-12">
    ...
    <div className="col-span-12 p-2 border-2 rounded-lg my-2 w-full">{ body }</div>
